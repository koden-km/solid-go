...
func NewVector4(w, x, y, z float64) *Vector4 {
...
func (v *Vector4) Div(u *Vector4, x float64) *Vector4 {
	v.W = u.W / x
	v.X = u.X / x
	v.Y = u.Y / x
	v.Z = u.Z / x
...
func (v *Vector4) Mul(u *Vector4, x float64) *Vector4 {
	v.W = u.W * x
	v.X = u.X * x
	v.Y = u.Y * x
	v.Z = u.Z * x
